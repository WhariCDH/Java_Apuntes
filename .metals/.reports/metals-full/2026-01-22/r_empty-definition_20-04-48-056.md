error id: file:///C:/Users/Dayana/Java_Apuntes/Clase03/CRUD21.java:java/sql/DriverManager#getConnection(+1).
file:///C:/Users/Dayana/Java_Apuntes/Clase03/CRUD21.java
empty definition using pc, found symbol in pc: java/sql/DriverManager#getConnection(+1).
...
public class CRUD21 {
    ...
    public static void main(String[] args) {
        ...
        try{
            Connection conexion=DriverManager.get@@Connection(url, user, password);
